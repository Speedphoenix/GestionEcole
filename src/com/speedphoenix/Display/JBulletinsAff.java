...
public class JBulletinsAff {
    ...
    public JBulletinsAff(int id, int elORtrim, TreeMap<Integer, Bulletin> mapToCopy) {
    ...
    /*private JPanel mainPanel;//JPanel qu'on va envoyer sur mainframe
    private JList<String> mainList;// Jliste qui va afficher les informations
    private DefaultListModel <JLabel> buffList;// Liste qui va assembles les strings contenant les informations a afficher
    private TreeMap<Integer, Bulletin> mapCopy;//map contenant les objets avec les infos
